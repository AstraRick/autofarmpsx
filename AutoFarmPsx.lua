...
--Main
local Main = Window:NewTab("InfYield")
	local Section = Main:NewSection("InfYield")

	Section:NewButton("InfiniteYield", "Hacku", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)



local Main = Window:NewTab("Auto Farm Psx")
	local Section = Main:NewSection("AutoFarm")

	Section:NewButton("AutoFarm", "AutoFarm", function()    
loadstring(game:HttpGet("https://raw.githubusercontent.com/ScriptRUs/Banana/main/PetSimulatorX.lua"))()
end)
